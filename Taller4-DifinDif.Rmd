...
Los resultados del modelo con interacción sugieren que la cobertura de Globo tiene un efecto negativo y significativo sobre la fertilidad, pero este impacto no es homogéneo entre todas las mujeres, sino que varía en función de su nivel educativo. Mientras que la educación, de manera independiente, ya está asociada con una menor probabilidad de tener hijos, el término de interacción evidencia que el efecto reductor de Globo es más pronunciado en los grupos con menor escolaridad.

A medida que aumentan los años de educación, la magnitud del efecto de Globo sobre la reducción de la fertilidad se atenúa progresivamente, hasta volverse poco relevante en los niveles más altos de educación. Esto sugiere que la influencia de los contenidos transmitidos por Globo en las decisiones reproductivas tiene un mayor alcance en mujeres con menores recursos educativos, posiblemente porque en este grupo los mensajes transmitidos por los medios desempeñan un papel más central en la configuración de aspiraciones y proyectos de vida.
